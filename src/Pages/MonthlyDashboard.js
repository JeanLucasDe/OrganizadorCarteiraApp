        ...
        <div className={`collapse navbar-collapse ${isOpen ? 'show' : ''}`} id="navbarNav">
          <ul className="navbar-nav ml-auto">
            <li className="nav-item">
              <a className={`nav-link ${selectedCategory === 'geral' ? styles.activeNav : ''}`} type='button' onClick={() => setSelectedCategory('geral')}>Geral</a>
            </li>
            <li className="nav-item">
              <a className={`nav-link ${selectedCategory === 'debts' ? styles.activeNav : ''}`}type='button' onClick={() => setSelectedCategory('debts')}>Dívidas</a>
            </li>
            
            <li className="nav-item">
              <a className={`nav-link ${selectedCategory === 'monthlyExpenses' ? styles.activeNav : ''}`} type='button' onClick={() => setSelectedCategory('monthlyExpenses')}>Gastos Mensais</a>
            </li>
            <li className="nav-item">
              <a className={`nav-link ${selectedCategory === 'guaranteeFund' ? styles.activeNav : ''}`} type='button' onClick={() => setSelectedCategory('guaranteeFund')}>Fundo de Garantia</a>
            </li>
            <li className="nav-item">
              <a className={`nav-link ${selectedCategory === 'thirteenthSalary' ? styles.activeNav : ''}`} type='button' onClick={() => setSelectedCategory('thirteenthSalary')}>Décimo Terceiro</a>
            </li>
            <li className="nav-item">
